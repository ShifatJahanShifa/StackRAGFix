...
If you think that the question is not complex enough to divide, just return the original question in a python list. Enclosed each question wuth double quote ("") in the list. (NO PREAMBLE)
Question: {question}
"""
